    ...
    const columns = useMemo(() => [
        ...
        columnHelper.accessor('defaultValue', {
            ...
            cell: info => {
                ...
                return val ? 
                <span className={`font-mono text-xs px-1 rounded border max-w-[80px] truncate block ${isDark ? "bg-[#21252b] text-[#98c379] border-[#3e4451]" : "bg-default-50 text-default-600 border-default-100"}`} title={val as string}>{val as string}</span> : 
